...
export default function Navbar() {
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all rounded-2xl">
            <Link href="/" className="flex items-center shrink-0" aria-label="Teamart">
                <svg
                    width="157"
                    height="40"
                    viewBox="0 0 157 40"
                ...
                >
                    ...
                    />
                    <path
                        d="m8.75 11.3 6.75 3.884 6.75-3.885M8.75 34.58v-7.755L2 22.939m27 0-6.75 3.885v7.754M2.405 15.408 15.5 22.954l13.095-7.546M15.5 38V22.939M29 28.915V16.962a2.98 2.98 0 0 0-1.5-2.585L17 8.4a3.01 3.01 0 0 0-3 0L3.5 14.377A3 3 0 0 0 2 16.962v11.953A2.98 2.98 0 0 0 3.5 31.5L14 37.477a3.01 3.01 0 0 0 3 0L27.5 31.5a2.98 2.98 0 0 0 1.5-2.585"
                        stroke="#4F39F6"
                        strokeWidth="2.5"
                        strokeLinecap="round"
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                >
                    ...
                    {cartCount > 0 ? (
                        <span className="absolute -top-2 -right-3 text-xs text-white bg-indigo-500 w-[18px] h-[18px] rounded-full grid place-items-center">
                            {cartCount}
                        </span>
                    ) : null}
                </button>
                ...
                <Link
                    href="/sign-in"
                    className="cursor-pointer px-8 py-2 bg-indigo-500 hover:bg-indigo-600 transition text-white rounded-full text-sm font-semibold"
                >
                    Login
                </Link>
            </div>
            ...
            >
                ...
                <Link
                    href="/sign-in"
                    className="cursor-pointer px-6 py-2 mt-2 bg-indigo-500 hover:bg-indigo-600 transition text-white rounded-full text-sm font-semibold"
                >
                    Login
                </Link>
            </div>
